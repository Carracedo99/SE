 ...
 */
gpio_err_t gpio_set_port_dir_input (gpio_port_t port, uint32_t mask);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_port_dir_output (gpio_port_t port, uint32_t mask);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_pin_dir_input (gpio_pin_t pin);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_pin_dir_output (gpio_pin_t pin);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_port (gpio_port_t port, uint32_t mask);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_clear_port (gpio_port_t port, uint32_t mask);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_pin (gpio_pin_t pin);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_clear_pin (gpio_pin_t pin);
 ...
 *			  gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_get_port (gpio_port_t port, uint32_t *port_data);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_get_pin (gpio_pin_t pin, uint32_t *pin_data);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_port_func (gpio_port_t port, gpio_func_t func, uint32_t mask);
 ...
 *			gpio_invalid_parameter en otro caso
 */
gpio_err_t gpio_set_pin_func (gpio_pin_t pin, gpio_func_t func);
